{% macro get_campaign_delivery_columns() %}
...
{{ stackadapt.stackadapt_add_pass_through_columns(base_columns=columns, pass_through_fields=var('stackadapt__campaign_delivery_passthrough_metrics')) }}
