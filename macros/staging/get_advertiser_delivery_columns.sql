{% macro get_advertiser_delivery_columns() %}
...
{{ stackadapt.stackadapt_add_pass_through_columns(base_columns=columns, pass_through_fields=var('stackadapt__advertiser_delivery_passthrough_metrics')) }}
